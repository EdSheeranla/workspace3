...
public class OrderAction extends ActionSupport implements ModelDriven<Order> {
     ...
     * 封装一个订单对象
     */
    private void createOrder(ShoppingCart shoppingCart) {

        User user = (User) getRequest().getSession().getAttribute("loginUser");
        setOrder(shoppingCart, user);
    ...
    private void setOrder(ShoppingCart shoppingCart, User user) {
    ...
    private boolean isEmpty(ShoppingCart shoppingCart) {
        return shoppingCart == null || shoppingCart.getCartItems().size() == 0;
    }

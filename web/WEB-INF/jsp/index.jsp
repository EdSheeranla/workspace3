    ...
    <div class="span24">
        <div id="hotProduct" class="hotProduct clearfix">
            ...
            <ul class="tabContent" style="display: block;">
                ...
                <li>
                    <a target="_blank" href="${pageContext.request.contextPath}/product_showProduct.action?pid=${hotproduct.pid}"><img src="./${hotproduct.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
                </li>
                </c:forEach>
    ...
    <div class="span24">
        <div id="newProduct" class="newProduct clearfix">
            ...
            <!-- 					<div class="newProductAd">
                                     ...
                                     -->
            <ul class="tabContent" style="display: block;">
                <c:forEach items="${lastproductList}" var="lastproduct">
                <li>
                    <a  target="_blank"><img src="./${lastproduct.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>
                </li>
                </c:forEach>
            </ul>
            <ul class="tabContent" style="display: none;">

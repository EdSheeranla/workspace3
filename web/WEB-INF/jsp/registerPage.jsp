...
<script type="text/javascript" language="JavaScript">
    function  registerValidate() {
        ...
        var Reg=/^[\d\w]+@([\d\w]+\.)+(com|net|org|cn)$/;
    ...
    <div class="span5">
        <div class="logo">
            <a href="http://localhost:8080/mango/">
                <img src="./image/r___________renleipic_01/logo.gif" alt="EdSheeran">
            </a>
        </div>
    </div>
    <div class="span9">
    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm"  method="post" action="${pageContext.request.contextPath}/user_register.action" novalidate="novalidate" onsubmit="return registerValidate()">
                    <table>
                        <tbody><tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="telnum" class="text" onfocus="WdatePicker();">
                                <span><s:fielderror fieldName="telnum"/> </span>
                            </td>
                        </tr>
...
<div id="_my97DP" style="position: absolute; top: -1970px; left: -1970px;"><iframe style="width: 190px; height: 191px;" src="./会员注册 - Powered By Mango Team_files/My97DatePicker.htm" frameborder="0" border="0" scrolling="no"></iframe></div></body>
</html>